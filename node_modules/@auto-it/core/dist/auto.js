...
exports.LabelExistsError = exports.getAutoVersion = exports.determineNextVersion = void 0;
...
class Auto {
    ...
    async canary(args = {}) {
      ...
      `);
        ...
        let version = semver_2.calculateSemVerBump(labels, this.semVerLabels, this.config);
        if (version === semver_2.default.noVersion) {
            if (options.force) {
                version = semver_2.default.patch;
            }
            else {
      ...
      `);
        ...
        this.hooks.onCreateLogParse.tap("Omit merges from master", (logParse) => {
            logParse.hooks.omitCommit.tap("Omit merges from master", (commit) => {
                ...
                if (shouldOmit) {
                    this.logger.verbose.info(`Omitting merge commit from master: ${commit.subject}`);
                    return true;
                }
            });
        });
        ...
        const bump = semver_2.calculateSemVerBump(labels, this.semVerLabels, this.config) ||
...
Object.defineProperty(exports, "InteractiveInit", { enumerable: true, get: function () { return init_2.default; } });
...
Object.defineProperty(exports, "Auto", { enumerable: true, get: function () { return auto_1.default; } });
var semver_3 = require("./semver");
Object.defineProperty(exports, "SEMVER", { enumerable: true, get: function () { return semver_3.default; } });
var exec_promise_2 = require("./utils/exec-promise");
Object.defineProperty(exports, "execPromise", { enumerable: true, get: function () { return exec_promise_2.default; } });
var get_lerna_packages_1 = require("./utils/get-lerna-packages");
Object.defineProperty(exports, "getLernaPackages", { enumerable: true, get: function () { return get_lerna_packages_1.default; } });
var in_folder_1 = require("./utils/in-folder");
Object.defineProperty(exports, "inFolder", { enumerable: true, get: function () { return in_folder_1.default; } });
