...
describe("github", () => {
    ...
    describe("getLabels", () => {
        test("successful", async () => {
            const gh = new git_1.default(options);
    ...
    describe("getTagNotInBaseBranch", () => {
        ...
        test("finds first tag not in base branch", async () => {
            ...
            expect(await gh.getTagNotInBaseBranch("branch", { first: true })).toBe("1.4.0-next");
        });
        test("handles tags with package names", async () => {
            ...
            expect(await gh.getTagNotInBaseBranch("branch")).toBe("@monorepo/core@6.0.1-next.0");
        });
    });
    test("publish", async () => {
        const gh = new git_1.default(options);
    ...
    describe("Name of the group", () => {
        ...
        test("override graphql API", async () => {
            const gh = new git_1.default(Object.assign(Object.assign({}, options), { baseUrl: "https://api.internal.com" }));
            await gh.publish("releaseNotes", "tag");
            // @ts-ignore
    ...
    test("getFirstCommit ", async () => {
        const gh = new git_1.default(options);
        expect(await gh.getFirstCommit()).toBe("0b2af75d8b55c8869cda93d0e5589ad9f2677e18");
    });
    ...
    test("getCommitDate ", async () => {
        const gh = new git_1.default(options);
        expect(await gh.getCommitDate("0b2af75d8b55c8869cda93d0e5589ad9f2677e18")).toBe("2018-12-03T15:19:38-0800");
    });
    test("getSha", async () => {
        const gh = new git_1.default(options);
    ...
    test("getGitLog", async () => {
        const gh = new git_1.default(options);
        expect(await gh.getGitLog("0b2af75d8b55c8869cda93d0e5589ad9f2677e18", "a7f6634429731055a5a44bae24ac88c5f9822e58")).toMatchSnapshot();
    });
    test("getGitLog - merge commits", async () => {
        const gh = new git_1.default(options);
        expect((await gh.getGitLog("fb857b8939fa2c95a3202613d36a12aa3341d109", "024c66aa21cff5947957ed3bdfb4a616aa3f0046"))[0]).toMatchSnapshot();
    });
    test("getUser", async () => {
        const gh = new git_1.default(options);
    ...
    describe("getLatestRelease", () => {
        ...
        test("no tags", async () => {
            ...
            expect(await gh.getLatestRelease()).toBe("0b2af75d8b55c8869cda93d0e5589ad9f2677e18");
        });
        test("handles errors", async () => {
            const gh = new git_1.default(options);
    ...
    describe("getProjectLabels ", () => {
        test("return labels", async () => {
            const gh = new git_1.default(options);
            paginate.mockReturnValueOnce(Promise.resolve([{ name: "first label" }, { name: "second label" }]));
    ...
    describe("error hook", () => {
        test("strip authorization headers from error", () => {
            ...
            new git_1.default(options);
            expect(errorHook).toHaveBeenCalled();
            const errorHandler = errorHook.mock.calls[0][1];
            expect(errorHandler.bind(undefined, error({ authorization: "token abc" }))).toThrow(error());
        });
    });
});
