...
describe("Auto", () => {
    ...
    describe("canary", () => {
        ...
        test("calls the canary hook with the pr info", async () => {
            ...
            expect(canary).toHaveBeenCalledWith(semver_1.default.patch, "canary.123.1");
        ...
        test("defaults to sha when run locally", async () => {
            ...
            auto.hooks.canary.tap("test", canary);
            await auto.canary();
            expect(canary).toHaveBeenCalledWith(semver_1.default.patch, "canary.abcd");
        });
    ...
    describe("next", () => {
        ...
        test("does not call next hook in dry-run", async () => {
            ...
            await auto.loadConfig();
            auto.remote = "origin";
            auto.git.getProject = () => Promise.resolve({ data: {} });
            auto.git.getLatestRelease = () => Promise.resolve("1.2.3");
    ...
    describe("shipit", () => {
        ...
        test("should not publish when behind remote", async () => {
            jest.spyOn(child_process_1.default, "execSync").mockImplementation((command) => {
