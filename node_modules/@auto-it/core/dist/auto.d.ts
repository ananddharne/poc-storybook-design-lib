...
import { AsyncParallelHook, AsyncSeriesBailHook, SyncHook, SyncWaterfallHook, AsyncSeriesHook, AsyncSeriesWaterfallHook } from "tapable";
import { ApiOptions, IInfoOptions, ICanaryOptions, IChangelogOptions, ICommentOptions, ICreateLabelsOptions, ILabelOptions, IPRCheckOptions, IPRStatusOptions, IReleaseOptions, IShipItOptions, IVersionOptions, INextOptions } from "./auto-args";
...
export interface IAutoHooks {
    ...
    getRepository: AsyncSeriesBailHook<[], (RepoInformation & TestingToken) | void>;
...
export default class Auto {
    ...
    loadConfig(): Promise<{
        ...
        labels: ({
            ...
            releaseType?: SEMVER.major | SEMVER.minor | SEMVER.patch | "skip" | "release" | "none" | undefined;
