...
class Changelog {
    ...
    splitCommits(commits) {
        ...
        const defaultPatchLabelName = ((_a = this.options.labels.find((l) => l.default)) === null || _a === void 0 ? void 0 : _a.name) || ((_b = this.options.labels.find((l) => l.releaseType === "patch")) === null || _b === void 0 ? void 0 : _b.name) ||
            "patch";
        commits
            .filter(({ labels }) => 
